    ...
    >
      <div className="w-full h-full max-w-6xl mx-auto flex items-center justify-between p-2">
        ...
        <div className="flex items-center justify-center gap-4">
          <button className="px-4 py-2 rounded-full bg-transparent border border-neutral-200 hover:bg-neutral-300/20 dark:hover:bg-neutral-700/20 dark:border-neutral-800 font-inter text-sm flex gap-2 items-start transition-all duration-300 text-neutral-600 hover:text-foreground">
            <span>
